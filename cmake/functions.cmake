...
function(generate_build_flags)
    ...
    if(WOLFSSL_TESTAPPS AND NOT WOLFSSL_LEAN_TLS)
        set(BUILD_TESTAPP_SERVERS "yes" PARENT_SCOPE)
    endif()
    set(BUILD_TESTAPP_CLIENTS ${WOLFSSL_TESTAPPS} PARENT_SCOPE)
    set(BUILD_TESTS ${WOLFSSL_TESTAPPS} PARENT_SCOPE)
    if(NOT WOLFSSL_SINGLETHREADED AND WOLFSSL_TESTAPPS AND NOT WOLFSSL_LEAN_TLS)
        set(BUILD_THREADED_TESTAPPS "yes" PARENT_SCOPE)
    endif()
