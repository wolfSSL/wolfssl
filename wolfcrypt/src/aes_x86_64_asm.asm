...
AES_CTR_encrypt_vaes PROC
        ...
        vbroadcasti128	ymm13, OWORD PTR [ptr_L_aes_ctr_inc_vaes+16]
        xor	r11d, r11d
        cmp	r8d, 128
        mov	r12d, r8d
...
L_AES_CTR_encrypt_vaes_enc_128:
        ...
        vpaddq	ymm7, ymm7, ymm9
        ; aes_enc_block
        vbroadcasti128	ymm14, OWORD PTR [r9]
        vpxor	ymm0, ymm0, ymm14
        vpxor	ymm1, ymm1, ymm14
        vpxor	ymm2, ymm2, ymm14
        vpxor	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+16]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+32]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+48]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+64]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+80]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+96]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+112]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+128]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+144]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        cmp	eax, 11
        vbroadcasti128	ymm14, OWORD PTR [r9+160]
        jl	L_AES_CTR_encrypt_vaes_128_aes_enc_block_last
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+176]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        cmp	eax, 13
        vbroadcasti128	ymm14, OWORD PTR [r9+192]
        jl	L_AES_CTR_encrypt_vaes_128_aes_enc_block_last
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+208]
        vaesenc	ymm0, ymm0, ymm14
        vaesenc	ymm1, ymm1, ymm14
        vaesenc	ymm2, ymm2, ymm14
        vaesenc	ymm3, ymm3, ymm14
        vbroadcasti128	ymm14, OWORD PTR [r9+224]
...
AES_CTR_encrypt_avx512 PROC
        ...
        vbroadcasti32x4	zmm18, OWORD PTR [r9+48]
        vbroadcasti32x4	zmm19, OWORD PTR [r9+64]
        vbroadcasti32x4	zmm20, OWORD PTR [r9+80]
        vbroadcasti32x4	zmm21, OWORD PTR [r9+96]
        vbroadcasti32x4	zmm22, OWORD PTR [r9+112]
        vbroadcasti32x4	zmm23, OWORD PTR [r9+128]
        vbroadcasti32x4	zmm24, OWORD PTR [r9+144]
        vbroadcasti32x4	zmm25, OWORD PTR [r9+160]
        cmp	eax, 11
        jl	L_AES_CTR_encrypt_avx512_key_cached
        vbroadcasti32x4	zmm26, OWORD PTR [r9+176]
        vbroadcasti32x4	zmm27, OWORD PTR [r9+192]
        cmp	eax, 13
        jl	L_AES_CTR_encrypt_avx512_key_cached
        vbroadcasti32x4	zmm28, OWORD PTR [r9+208]
        vbroadcasti32x4	zmm29, OWORD PTR [r9+224]
