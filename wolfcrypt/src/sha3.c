...
static
#endif
int wc_InitSha3(Sha3* sha3, void* heap, int devId)
{
    int ret = 0;
...
static
#endif
int wc_Sha3Update(Sha3* sha3, const byte* data, word32 len, byte p)
{
    int ret = 0;
...
static
#endif
int wc_Sha3Final(Sha3* sha3, byte* hash, byte p, byte len)
{
    int ret;
