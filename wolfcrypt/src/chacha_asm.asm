...
chacha20_poly1305_avx512 PROC
        ...
        sub	rsp, 888
        vmovdqu	OWORD PTR [rsp+728], xmm6
        vmovdqu	OWORD PTR [rsp+744], xmm7
        vmovdqu	OWORD PTR [rsp+760], xmm8
        vmovdqu	OWORD PTR [rsp+776], xmm9
        vmovdqu	OWORD PTR [rsp+792], xmm10
        vmovdqu	OWORD PTR [rsp+808], xmm11
        vmovdqu	OWORD PTR [rsp+824], xmm12
        vmovdqu	OWORD PTR [rsp+840], xmm13
        vmovdqu	OWORD PTR [rsp+856], xmm14
        vmovdqu	OWORD PTR [rsp+872], xmm15
        ...
        vmovdqa64	OWORD PTR [r14], xmm16
        vmovdqa64	OWORD PTR [r14+16], xmm17
        vmovdqa64	OWORD PTR [r14+32], xmm18
        vmovdqa64	OWORD PTR [r14+48], xmm19
        vmovdqa64	OWORD PTR [r14+64], xmm20
        vmovdqa64	OWORD PTR [r14+80], xmm21
        vmovdqa64	OWORD PTR [r14+96], xmm22
        vmovdqa64	OWORD PTR [r14+112], xmm23
        vmovdqa64	OWORD PTR [r14+128], xmm24
        vmovdqa64	OWORD PTR [r14+144], xmm25
        vmovdqa64	OWORD PTR [r14+160], xmm26
        vmovdqa64	OWORD PTR [r14+176], xmm27
        vmovdqa64	OWORD PTR [r14+192], xmm28
        vmovdqa64	OWORD PTR [r14+208], xmm29
        vmovdqa64	OWORD PTR [r14+224], xmm30
        vmovdqa64	OWORD PTR [r14+240], xmm31
        mov	r8b, 10
L_chacha20_poly1305_rounds:
        ...
        vmovdqa64	OWORD PTR [r15], xmm24
        vmovdqa64	OWORD PTR [r15+16], xmm25
        vmovdqa64	OWORD PTR [r15+32], xmm26
        vmovdqa64	OWORD PTR [r15+48], xmm27
        vmovdqa64	OWORD PTR [r15+64], xmm28
        vmovdqa64	OWORD PTR [r15+80], xmm29
        vmovdqa64	OWORD PTR [r15+96], xmm30
        vmovdqa64	OWORD PTR [r15+112], xmm31
        ...
        vmovdqu64	xmm24, OWORD PTR [rdx]
        vmovdqu64	xmm25, OWORD PTR [rdx+16]
        vmovdqu64	xmm26, OWORD PTR [rdx+64]
        vmovdqu64	xmm27, OWORD PTR [rdx+80]
        vmovdqu64	xmm28, OWORD PTR [rdx+128]
        vmovdqu64	xmm29, OWORD PTR [rdx+144]
        vmovdqu64	xmm30, OWORD PTR [rdx+192]
        vmovdqu64	xmm31, OWORD PTR [rdx+208]
        ...
        vmovdqu64	OWORD PTR [rcx], xmm16
        vmovdqu64	OWORD PTR [rcx+16], xmm17
        vmovdqu64	OWORD PTR [rcx+64], xmm18
        vmovdqu64	OWORD PTR [rcx+80], xmm19
        vmovdqu64	OWORD PTR [rcx+128], xmm20
        vmovdqu64	OWORD PTR [rcx+144], xmm21
        vmovdqu64	OWORD PTR [rcx+192], xmm22
        vmovdqu64	OWORD PTR [rcx+208], xmm23
        vmovdqa64	xmm16, OWORD PTR [r15]
        vmovdqa64	xmm17, OWORD PTR [r15+16]
        vmovdqa64	xmm18, OWORD PTR [r15+32]
        vmovdqa64	xmm19, OWORD PTR [r15+48]
        vmovdqa64	xmm20, OWORD PTR [r15+64]
        vmovdqa64	xmm21, OWORD PTR [r15+80]
        vmovdqa64	xmm22, OWORD PTR [r15+96]
        vmovdqa64	xmm23, OWORD PTR [r15+112]
        vpunpckldq	xmm24, xmm16, xmm17
        vpunpckldq	xmm25, xmm18, xmm19
        vpunpckhdq	xmm28, xmm16, xmm17
        vpunpckhdq	xmm29, xmm18, xmm19
        ...
        vpunpckhqdq	xmm22, xmm28, xmm29
        vpunpckhqdq	xmm23, xmm30, xmm31
        vmovdqu64	xmm24, OWORD PTR [rdx+32]
        vmovdqu64	xmm25, OWORD PTR [rdx+48]
        vmovdqu64	xmm26, OWORD PTR [rdx+96]
        vmovdqu64	xmm27, OWORD PTR [rdx+112]
        vmovdqu64	xmm28, OWORD PTR [rdx+160]
        vmovdqu64	xmm29, OWORD PTR [rdx+176]
        vmovdqu64	xmm30, OWORD PTR [rdx+224]
        vmovdqu64	xmm31, OWORD PTR [rdx+240]
        vpxord	xmm16, xmm16, xmm24
        vpxord	xmm17, xmm17, xmm25
        vpxord	xmm18, xmm18, xmm26
        vpxord	xmm19, xmm19, xmm27
        ...
        vpxord	xmm22, xmm22, xmm30
        vpxord	xmm23, xmm23, xmm31
        vmovdqu64	OWORD PTR [rcx+32], xmm16
        vmovdqu64	OWORD PTR [rcx+48], xmm17
        vmovdqu64	OWORD PTR [rcx+96], xmm18
        vmovdqu64	OWORD PTR [rcx+112], xmm19
        vmovdqu64	OWORD PTR [rcx+160], xmm20
        vmovdqu64	OWORD PTR [rcx+176], xmm21
        vmovdqu64	OWORD PTR [rcx+224], xmm22
        vmovdqu64	OWORD PTR [rcx+240], xmm23
        vmovdqa64	xmm28, OWORD PTR [r14+192]
        vpaddd	xmm28, xmm28, OWORD PTR [r11]
        vmovdqa64	OWORD PTR [r14+192], xmm28
        vmovdqa64	xmm16, OWORD PTR [r14]
        vmovdqa64	xmm17, OWORD PTR [r14+16]
        vmovdqa64	xmm18, OWORD PTR [r14+32]
        vmovdqa64	xmm19, OWORD PTR [r14+48]
        vmovdqa64	xmm20, OWORD PTR [r14+64]
        vmovdqa64	xmm21, OWORD PTR [r14+80]
        vmovdqa64	xmm22, OWORD PTR [r14+96]
        vmovdqa64	xmm23, OWORD PTR [r14+112]
        vmovdqa64	xmm24, OWORD PTR [r14+128]
        vmovdqa64	xmm25, OWORD PTR [r14+144]
        vmovdqa64	xmm26, OWORD PTR [r14+160]
        vmovdqa64	xmm27, OWORD PTR [r14+176]
        vmovdqa64	xmm28, OWORD PTR [r14+192]
        vmovdqa64	xmm29, OWORD PTR [r14+208]
        vmovdqa64	xmm30, OWORD PTR [r14+224]
        vmovdqa64	xmm31, OWORD PTR [r14+240]
        add	rdx, 256
        add	rcx, 256
        sub	eax, 256
...
L_chacha20_poly1305_epilogue:
        ...
        vmovd	[rdi+48], xmm28
        vzeroupper
        vmovdqu	xmm6, OWORD PTR [rsp+728]
        vmovdqu	xmm7, OWORD PTR [rsp+744]
        vmovdqu	xmm8, OWORD PTR [rsp+760]
        vmovdqu	xmm9, OWORD PTR [rsp+776]
        vmovdqu	xmm10, OWORD PTR [rsp+792]
        vmovdqu	xmm11, OWORD PTR [rsp+808]
        vmovdqu	xmm12, OWORD PTR [rsp+824]
        vmovdqu	xmm13, OWORD PTR [rsp+840]
        vmovdqu	xmm14, OWORD PTR [rsp+856]
        vmovdqu	xmm15, OWORD PTR [rsp+872]
        add	rsp, 888
        pop	rbp
        pop	rbx
        pop	r15
...
chacha20_poly1305_ifma PROC
        ...
        vmovdqu64	zmm8, [r11+512]
        vmovdqu64	zmm9, [r11+576]
        vmovdqu64	zmm10, [r11+640]
        vmovdqu64	zmm11, [r11+704]
        vmovdqu64	zmm12, [r11+768]
        vmovdqu64	zmm13, [r11+832]
        vmovdqu64	zmm14, [r11+896]
        vmovdqu64	zmm15, [r11+960]
        add	rdx, 1024
        add	rcx, 1024
        sub	eax, 1024
        jz	L_cp512_epi
...
chacha20_poly1305_small_enc PROC
        ...
        sub	rsp, 360
        vmovdqu	OWORD PTR [rsp+200], xmm6
        vmovdqu	OWORD PTR [rsp+216], xmm7
        vmovdqu	OWORD PTR [rsp+232], xmm8
        vmovdqu	OWORD PTR [rsp+248], xmm9
        vmovdqu	OWORD PTR [rsp+264], xmm10
        vmovdqu	OWORD PTR [rsp+280], xmm11
        vmovdqu	OWORD PTR [rsp+296], xmm12
        vmovdqu	OWORD PTR [rsp+312], xmm13
        vmovdqu	OWORD PTR [rsp+328], xmm14
        vmovdqu	OWORD PTR [rsp+344], xmm15
...
L_c20p1305_small_ct_done:
        ...
        vmovdqu	xmm6, OWORD PTR [rsp+200]
        vmovdqu	xmm7, OWORD PTR [rsp+216]
        vmovdqu	xmm8, OWORD PTR [rsp+232]
        vmovdqu	xmm9, OWORD PTR [rsp+248]
        vmovdqu	xmm10, OWORD PTR [rsp+264]
        vmovdqu	xmm11, OWORD PTR [rsp+280]
        vmovdqu	xmm12, OWORD PTR [rsp+296]
        vmovdqu	xmm13, OWORD PTR [rsp+312]
        vmovdqu	xmm14, OWORD PTR [rsp+328]
        vmovdqu	xmm15, OWORD PTR [rsp+344]
        add	rsp, 360
        pop	rbp
        pop	rbx
        pop	rsi
