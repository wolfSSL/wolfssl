...
chacha_encrypt_avx1 PROC
        ...
        vpaddd	xmm12, xmm12, OWORD PTR L_chacha20_avx1_add
...
L_chacha20_avx1_loop128:
        ...
        vpshufb	xmm12, xmm12, OWORD PTR L_chacha20_avx1_rotl16
        vpaddd	xmm8, xmm8, xmm12
        vpxor	xmm4, xmm4, xmm8
        vpaddd	xmm1, xmm1, xmm5
        vpxor	xmm13, xmm13, xmm1
        vpshufb	xmm13, xmm13, OWORD PTR L_chacha20_avx1_rotl16
        vpaddd	xmm9, xmm9, xmm13
        vpxor	xmm5, xmm5, xmm9
        vpaddd	xmm2, xmm2, xmm6
        vpxor	xmm14, xmm14, xmm2
        vpshufb	xmm14, xmm14, OWORD PTR L_chacha20_avx1_rotl16
        vpaddd	xmm10, xmm10, xmm14
        vpxor	xmm6, xmm6, xmm10
        vpaddd	xmm3, xmm3, xmm7
        vpxor	xmm15, xmm15, xmm3
        vpshufb	xmm15, xmm15, OWORD PTR L_chacha20_avx1_rotl16
        ...
        vpxor	xmm12, xmm12, xmm0
        vmovdqa	xmm11, OWORD PTR [r12+48]
        vpshufb	xmm12, xmm12, OWORD PTR L_chacha20_avx1_rotl8
        vpaddd	xmm8, xmm8, xmm12
        vpxor	xmm4, xmm4, xmm8
        vpaddd	xmm1, xmm1, xmm5
        vpxor	xmm13, xmm13, xmm1
        vpshufb	xmm13, xmm13, OWORD PTR L_chacha20_avx1_rotl8
        vpaddd	xmm9, xmm9, xmm13
        vpxor	xmm5, xmm5, xmm9
        vpaddd	xmm2, xmm2, xmm6
        vpxor	xmm14, xmm14, xmm2
        vpshufb	xmm14, xmm14, OWORD PTR L_chacha20_avx1_rotl8
        vpaddd	xmm10, xmm10, xmm14
        vpxor	xmm6, xmm6, xmm10
        vpaddd	xmm3, xmm3, xmm7
        vpxor	xmm15, xmm15, xmm3
        vpshufb	xmm15, xmm15, OWORD PTR L_chacha20_avx1_rotl8
        vpaddd	xmm11, xmm11, xmm15
        vpxor	xmm7, xmm7, xmm11
        vmovdqa	OWORD PTR [r12+48], xmm11
        ...
        add	rdx, 256
        add	r8, 256
        vpaddd	xmm12, xmm12, OWORD PTR L_chacha20_avx1_four
        subl	r9d, 256
        vmovdqa	OWORD PTR [r11+192], xmm12
        cmp	r9d, 256
...
L_chacha20_avx1_block_crypt_start:
        ...
        vpshufb	xmm3, xmm3, OWORD PTR L_chacha20_avx1_rotl16
        ...
        vpaddd	xmm0, xmm0, xmm1
        vpxor	xmm3, xmm3, xmm0
        vpshufb	xmm3, xmm3, OWORD PTR L_chacha20_avx1_rotl8
        vpaddd	xmm2, xmm2, xmm3
        vpxor	xmm1, xmm1, xmm2
        vpsrld	xmm4, xmm1, 25
        vpslld	xmm1, xmm1, 7
...
chacha_encrypt_avx2 PROC
        sub	rsp, 944
        vmovdqu	OWORD PTR [rsp+784], xmm6
        vmovdqu	OWORD PTR [rsp+800], xmm7
        vmovdqu	OWORD PTR [rsp+816], xmm8
        vmovdqu	OWORD PTR [rsp+832], xmm9
        vmovdqu	OWORD PTR [rsp+848], xmm10
        vmovdqu	OWORD PTR [rsp+864], xmm11
        vmovdqu	OWORD PTR [rsp+880], xmm12
        vmovdqu	OWORD PTR [rsp+896], xmm13
        vmovdqu	OWORD PTR [rsp+912], xmm14
        vmovdqu	OWORD PTR [rsp+928], xmm15
        mov	r11, rsp
        ...
        vpbroadcastd	ymm1, [rcx+4]
        vpbroadcastd	ymm2, [rcx+8]
        vpbroadcastd	ymm3, [rcx+12]
        vpbroadcastd	ymm4, [rcx+16]
        vpbroadcastd	ymm5, [rcx+20]
        vpbroadcastd	ymm6, [rcx+24]
        vpbroadcastd	ymm7, [rcx+28]
        vpbroadcastd	ymm8, [rcx+32]
        vpbroadcastd	ymm9, [rcx+36]
        vpbroadcastd	ymm10, [rcx+40]
        vpbroadcastd	ymm11, [rcx+44]
        vpbroadcastd	ymm12, [rcx+48]
        vpbroadcastd	ymm13, [rcx+52]
        vpbroadcastd	ymm14, [rcx+56]
        vpbroadcastd	ymm15, [rcx+60]
        vpaddd	ymm12, ymm12, ptr_L_chacha20_avx2_add
...
L_chacha20_avx2_loop256:
        ...
        vpshufb	ymm12, ymm12, ptr_L_chacha20_avx2_rotl16
        vpaddd	ymm8, ymm8, ymm12
        vpxor	ymm4, ymm4, ymm8
        vpaddd	ymm1, ymm1, ymm5
        vpxor	ymm13, ymm13, ymm1
        vpshufb	ymm13, ymm13, ptr_L_chacha20_avx2_rotl16
        vpaddd	ymm9, ymm9, ymm13
        vpxor	ymm5, ymm5, ymm9
        vpaddd	ymm2, ymm2, ymm6
        vpxor	ymm14, ymm14, ymm2
        vpshufb	ymm14, ymm14, ptr_L_chacha20_avx2_rotl16
        vpaddd	ymm10, ymm10, ymm14
        vpxor	ymm6, ymm6, ymm10
        vpaddd	ymm3, ymm3, ymm7
        vpxor	ymm15, ymm15, ymm3
        vpshufb	ymm15, ymm15, ptr_L_chacha20_avx2_rotl16
        ...
        vpxor	ymm12, ymm12, ymm0
        vmovdqa	ymm11, YMMWORD PTR [r12+96]
        vpshufb	ymm12, ymm12, ptr_L_chacha20_avx2_rotl8
        vpaddd	ymm8, ymm8, ymm12
        vpxor	ymm4, ymm4, ymm8
        vpaddd	ymm1, ymm1, ymm5
        vpxor	ymm13, ymm13, ymm1
        vpshufb	ymm13, ymm13, ptr_L_chacha20_avx2_rotl8
        vpaddd	ymm9, ymm9, ymm13
        vpxor	ymm5, ymm5, ymm9
        vpaddd	ymm2, ymm2, ymm6
        vpxor	ymm14, ymm14, ymm2
        vpshufb	ymm14, ymm14, ptr_L_chacha20_avx2_rotl8
        vpaddd	ymm10, ymm10, ymm14
        vpxor	ymm6, ymm6, ymm10
        vpaddd	ymm3, ymm3, ymm7
        vpxor	ymm15, ymm15, ymm3
        vpshufb	ymm15, ymm15, ptr_L_chacha20_avx2_rotl8
        vpaddd	ymm11, ymm11, ymm15
        vpxor	ymm7, ymm7, ymm11
        vmovdqa	YMMWORD PTR [r12+96], ymm11
        ...
        add	rdx, 512
        add	r8, 512
        vpaddd	ymm12, ymm12, ptr_L_chacha20_avx2_eight
        subl	r9d, 512
        vmovdqa	YMMWORD PTR [r11+384], ymm12
        cmp	r9d, 512
...
L_chacha20_avx2_end256:
        ...
        vmovdqu	xmm6, OWORD PTR [rsp+784]
        vmovdqu	xmm7, OWORD PTR [rsp+800]
        vmovdqu	xmm8, OWORD PTR [rsp+816]
        vmovdqu	xmm9, OWORD PTR [rsp+832]
        vmovdqu	xmm10, OWORD PTR [rsp+848]
        vmovdqu	xmm11, OWORD PTR [rsp+864]
        vmovdqu	xmm12, OWORD PTR [rsp+880]
        vmovdqu	xmm13, OWORD PTR [rsp+896]
        vmovdqu	xmm14, OWORD PTR [rsp+912]
        vmovdqu	xmm15, OWORD PTR [rsp+928]
        add	rsp, 944
        ret
