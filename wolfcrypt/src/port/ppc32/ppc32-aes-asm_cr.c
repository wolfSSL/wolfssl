...
#define _WC_BUILDING_PPC32_AES_ASM_C
...
{
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
    register const unsigned char* key __asm__ ("r3") =
        (const unsigned char*)key_p;
    register word32 len __asm__ ("r4") = (word32)len_p;
    register unsigned char* ks __asm__ ("r5") = (unsigned char*)ks_p;
    register word8* L_AES_PPC32_sbox_c __asm__ ("r6") =
        (word8*)&L_AES_PPC32_sbox;
    register word32* L_AES_PPC32_rcon_c __asm__ ("r7") =
    ...
    "L_AES_set_encrypt_key_end_%=:\n\t"
        ...
        : [key] "r" (key), [len] "r" (len), [ks] "r" (ks),
          ...
          [L_AES_PPC32_rcon] "r" (L_AES_PPC32_rcon_c)
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
        : "memory", "cc", "r0", "r8", "r9", "r10", "r11", "r12", "r14", "r15",
            "r16", "r17"
    );
}
...
{
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
    register const unsigned char* in __asm__ ("r3") =
        (const unsigned char*)in_p;
    register unsigned char* out __asm__ ("r4") = (unsigned char*)out_p;
    register unsigned long len __asm__ ("r5") = (unsigned long)len_p;
    register const unsigned char* ks __asm__ ("r6") =
        (const unsigned char*)ks_p;
    register int nr __asm__ ("r7") = (int)nr_p;
    register word32* L_AES_PPC32_te_c __asm__ ("r8") =
        (word32*)&L_AES_PPC32_te;
#else
    register word32* L_AES_PPC32_te_c = (word32*)&L_AES_PPC32_te;
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */

    __asm__ __volatile__ (
        "mr      r16, %[L_AES_PPC32_te]\n\t"
        "addi    r17, r16, 0x400\n\t"
        "addi    r18, r16, 0x800\n\t"
        "addi    r19, r16, 0xc00\n\t"
        "add     r26, %[in], %[len]\n\t"
    ...
    "L_AES_ECB_encrypt_round_%=:\n\t"
        ...
        : [in] "r" (in), [out] "r" (out), [len] "r" (len), [ks] "r" (ks),
          [nr] "r" (nr), [L_AES_PPC32_te] "r" (L_AES_PPC32_te_c)
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
        : "memory", "cc", "r0", "r9", "r10", "r11", "r12", "r14", "r15", "r16",
...
{
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
    register unsigned char* ks __asm__ ("r3") = (unsigned char*)ks_p;
    register word32 rounds __asm__ ("r4") = (word32)rounds_p;
    register word8* L_AES_PPC32_sbox_c __asm__ ("r5") =
        (word8*)&L_AES_PPC32_sbox;
    register word32* L_AES_PPC32_td_c __asm__ ("r6") =
        (word32*)&L_AES_PPC32_td;
#else
    register word8* L_AES_PPC32_sbox_c = (word8*)&L_AES_PPC32_sbox;
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register const unsigned char* ks __asm__ ("r6") =
        (const unsigned char*)ks_p;
    register int nr __asm__ ("r7") = (int)nr_p;
    register word32* L_AES_PPC32_td_c __asm__ ("r8") =
        (word32*)&L_AES_PPC32_td;
    register word8* L_AES_PPC32_inv_sbox_c __asm__ ("r9") =
    ...
    "L_AES_ECB_decrypt_round_%=:\n\t"
        ...
        : [in] "r" (in), [out] "r" (out), [len] "r" (len), [ks] "r" (ks),
          ...
          [L_AES_PPC32_inv_sbox] "r" (L_AES_PPC32_inv_sbox_c)
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
        : "memory", "cc", "r0", "r10", "r11", "r12", "r14", "r15", "r16", "r17",
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register const unsigned char* ks __asm__ ("r6") =
        (const unsigned char*)ks_p;
    register int nr __asm__ ("r7") = (int)nr_p;
    register unsigned char* iv __asm__ ("r8") = (unsigned char*)iv_p;
    register word32* L_AES_PPC32_te_c __asm__ ("r9") =
        (word32*)&L_AES_PPC32_te;
#else
    register word32* L_AES_PPC32_te_c = (word32*)&L_AES_PPC32_te;
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register int nr __asm__ ("r7") = (int)nr_p;
    register unsigned char* iv __asm__ ("r8") = (unsigned char*)iv_p;
    register word32* L_AES_PPC32_td_c __asm__ ("r9") =
        (word32*)&L_AES_PPC32_td;
    register word8* L_AES_PPC32_inv_sbox_c __asm__ ("r10") =
        (word8*)&L_AES_PPC32_inv_sbox;
#else
    register word32* L_AES_PPC32_td_c = (word32*)&L_AES_PPC32_td;
    register word8* L_AES_PPC32_inv_sbox_c = (word8*)&L_AES_PPC32_inv_sbox;
    ...
    "L_AES_CBC_decrypt_round_%=:\n\t"
        ...
        : [in] "r" (in), [out] "r" (out), [len] "r" (len), [ks] "r" (ks),
          ...
          [L_AES_PPC32_inv_sbox] "r" (L_AES_PPC32_inv_sbox_c)
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
        : "memory", "cc", "r0", "r11", "r12", "r14", "r15", "r16", "r17", "r18",
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register const unsigned char* ks __asm__ ("r6") =
        (const unsigned char*)ks_p;
    register int nr __asm__ ("r7") = (int)nr_p;
    register unsigned char* ctr __asm__ ("r8") = (unsigned char*)ctr_p;
    register word32* L_AES_PPC32_te_c __asm__ ("r9") =
        (word32*)&L_AES_PPC32_te;
#else
    register word32* L_AES_PPC32_te_c = (word32*)&L_AES_PPC32_te;
...
{
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
    register unsigned char* x __asm__ ("r3") = (unsigned char*)x_p;
    register const unsigned char** m __asm__ ("r4") =
        (const unsigned char**)m_p;
    register const unsigned char* data __asm__ ("r5") =
        (const unsigned char*)data_p;
    register unsigned long len __asm__ ("r6") = (unsigned long)len_p;
    register word32* L_GCM_gmult_len_r_c __asm__ ("r7") =
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register const unsigned char* data __asm__ ("r5") =
        (const unsigned char*)data_p;
    register unsigned long len __asm__ ("r6") = (unsigned long)len_p;
    register word8* L_GCM_gmult_len_r_c __asm__ ("r7") =
