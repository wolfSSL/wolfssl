...
#define _WC_BUILDING_ARMV8_MLKEM_ASM_C
...
void mlkem_sha3_blocksx3_crypto(word64* state)
{
...
void mlkem_shake128_blocksx3_seed_crypto(word64* state, byte* seed)
{
    const word64* r = L_sha3_aarch64_r;
    __asm__ __volatile__ (
        "stp	x29, x30, [sp, #-64]!\n\t"
...
void mlkem_shake256_blocksx3_seed_crypto(word64* state, byte* seed)
{
    const word64* r = L_sha3_aarch64_r;
    __asm__ __volatile__ (
        "stp	x29, x30, [sp, #-64]!\n\t"
