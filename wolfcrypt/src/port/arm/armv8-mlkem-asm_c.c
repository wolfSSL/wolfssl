...
void mlkem_ntt(sword16* r)
{
    __asm__ __volatile__ (
        ...
        "stp	q19, q20, [x1, #224]\n\t"
        : [r] "+r" (r)
        : [%[L_mlkem_aarch64_consts]] "p" (%[L_mlkem_aarch64_consts]),
          [L_mlkem_aarch64_zetas] "p" (L_mlkem_aarch64_zetas),
          [L_mlkem_aarch64_zetas_qinv] "p" (L_mlkem_aarch64_zetas_qinv)
...
void mlkem_invntt(sword16* r)
{
    __asm__ __volatile__ (
        ...
        : [r] "+r" (r)
        : [%[L_mlkem_aarch64_consts]] "p" (%[L_mlkem_aarch64_consts]),
          [L_mlkem_aarch64_zetas_inv] "p" (L_mlkem_aarch64_zetas_inv),
          [L_mlkem_aarch64_zetas_inv_qinv] "p" (L_mlkem_aarch64_zetas_inv_qinv)
        : "memory", "cc", "x1", "x2", "x3", "x4", "v0", "v1", "v2", "v3", "v4",
            "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14",
            "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23",
            "v24", "v25", "v26", "v27", "v28"
...
void mlkem_basemul_mont(sword16* r, const sword16* a, const sword16* b)
{
    __asm__ __volatile__ (
        ...
        : [r] "+r" (r), [a] "+r" (a), [b] "+r" (b)
        : [%[L_mlkem_aarch64_consts]] "p" (%[L_mlkem_aarch64_consts]),
          [L_mlkem_aarch64_zetas_mul] "p" (L_mlkem_aarch64_zetas_mul)
...
void mlkem_csubq_neon(sword16* p)
{
    __asm__ __volatile__ (
        ...
        "st4	{v12.8h, v13.8h, v14.8h, v15.8h}, [%x[p]], #0x40\n\t"
        : [p] "+r" (p)
        : [L_mlkem_aarch64_q] "p" (L_mlkem_aarch64_q)
...
void mlkem_to_msg_neon(byte* msg, sword16* p)
{
    __asm__ __volatile__ (
        ...
        "st1	{v18.8b}, [%x[msg]], #8\n\t"
        : [msg] "+r" (msg), [p] "+r" (p)
        : [L_mlkem_to_msg_low] "p" (L_mlkem_to_msg_low),
          [L_mlkem_to_msg_high] "p" (L_mlkem_to_msg_high),
          [L_mlkem_to_msg_bits] "p" (L_mlkem_to_msg_bits)
...
void mlkem_from_msg_neon(sword16* p, const byte* msg)
{
    __asm__ __volatile__ (
        ...
        "st1	{v4.8h, v5.8h, v6.8h, v7.8h}, [%x[p]], #0x40\n\t"
        : [p] "+r" (p), [msg] "+r" (msg)
        : [L_mlkem_from_msg_q1half] "p" (L_mlkem_from_msg_q1half),
          [L_mlkem_from_msg_bits] "p" (L_mlkem_from_msg_bits)
    ...
    unsigned int rLen)
{
    ...
    "L_mlkem_rej_uniform_done_%=: \n\t"
        ...
        : [%[L_mlkem_aarch64_q]] "p" (%[L_mlkem_aarch64_q]),
          [L_mlkem_rej_uniform_mask] "p" (L_mlkem_rej_uniform_mask),
          [L_mlkem_rej_uniform_bits] "p" (L_mlkem_rej_uniform_bits),
          [L_mlkem_rej_uniform_indices] "p" (L_mlkem_rej_uniform_indices)
...
void mlkem_sha3_blocksx3_neon(word64* state)
{
    ...
    "L_SHA3_transform_blocksx3_neon_begin_%=: \n\t"
        ...
        "ldp	x29, x30, [sp], #0x40\n\t"
        : [state] "+r" (state)
        : [L_sha3_aarch64_r] "p" (L_sha3_aarch64_r)
