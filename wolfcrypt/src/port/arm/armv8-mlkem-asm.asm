...
mlkem_sha3_blocksx3_crypto PROC
	stp	x29, x30, [sp, #-224]!
	add	x29, sp, #0
	stp	x17, x19, [x29, #72]
	stp	x20, x21, [x29, #88]
...
L_SHA3_transform_blocksx3_crypto_begin
	...
	AREA	|.text|, CODE, READONLY
	ALIGN	4
	EXPORT	mlkem_shake128_blocksx3_seed_crypto
mlkem_shake128_blocksx3_seed_crypto PROC
	stp	x29, x30, [sp, #-224]!
	add	x29, sp, #0
	stp	x17, x19, [x29, #72]
	stp	x20, x21, [x29, #88]
...
L_SHA3_shake128_blocksx3_seed_crypto_begin
	...
	AREA	|.text|, CODE, READONLY
	ALIGN	4
	EXPORT	mlkem_shake256_blocksx3_seed_crypto
mlkem_shake256_blocksx3_seed_crypto PROC
	stp	x29, x30, [sp, #-224]!
	add	x29, sp, #0
	stp	x17, x19, [x29, #72]
	stp	x20, x21, [x29, #88]
