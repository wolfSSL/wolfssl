...
void Transform_Sha512_Len_neon(wc_Sha512* sha512, const byte* data, word32 len)
{
    ...
    "L_sha512_len_neon_start_%=: \n\t"
        ...
        : [L_SHA512_transform_neon_len_k] "p" (L_SHA512_transform_neon_len_k),
          [L_SHA512_transform_neon_len_r8] "p" (L_SHA512_transform_neon_len_r8)
    ...
    word32 len)
{
    ...
    "L_sha512_len_crypto_begin_%=: \n\t"
        ...
        : [sha512] "+r" (sha512), [data] "+r" (data), [len] "+r" (len)
        : [L_SHA512_trans_crypto_len_k] "p" (L_SHA512_trans_crypto_len_k)
