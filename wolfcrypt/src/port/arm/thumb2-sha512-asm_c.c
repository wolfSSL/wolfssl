...
#else
    void* L_asm_args[4] = {(void*)(size_t)sha512, (void*)(size_t)data,
        (void*)(size_t)len, (void*)(size_t)&L_SHA512_transform_len_k
    };
...
#ifdef WOLFSSL_NO_VAR_ASSIGN_REG
    sha512 = (wc_Sha512*)(size_t)L_asm_args[0];
    data = (const byte*)(size_t)L_asm_args[1];
