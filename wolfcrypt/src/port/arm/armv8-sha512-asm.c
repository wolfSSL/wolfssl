...
int Transform_Sha512_Len(wc_Sha512* sha512, const byte* data, word32 len)
{
    ...
    "L_sha512_len_neon_start_%=: \n\t"
        ...
        : "memory", "x3", "x4", "x5", "x6", "x7", "x8", "x9", "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17", "x18", "x19", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11"
    );
    return (uint32_t)(size_t)sha512;
}
