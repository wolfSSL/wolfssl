...
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
void AES_XTS_encrypt(const byte* in_p, byte* out_p, word32 sz_p,
...
#endif /* WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register word32* L_AES_PPC64_te4_0_c asm ("11") =
        (word32*)&L_AES_PPC64_te4_0;
#else
    register word32* L_AES_PPC64_te4_0_c = (word32*)&L_AES_PPC64_te4_0;
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
    ...
    "L_AES_XTS_encrypt_done_data_%=: \n\t"
        ...
        : [in] "+r" (in), [out] "+r" (out), [sz] "+r" (sz), [i] "+r" (i),
          ...
          [nr] "+r" (nr), [L_AES_PPC64_te4_0] "+r" (L_AES_PPC64_te4_0_c)
        :
        : "memory", "cc", "0", "12", "14", "15", "16", "17", "18", "19", "20",
...
#ifdef WOLFSSL_AES_XTS
#ifndef WOLFSSL_NO_VAR_ASSIGN_REG
void AES_XTS_decrypt(const byte* in_p, byte* out_p, word32 sz_p,
    const byte* i_p, byte* key_p, byte* key2_p, byte* tmp_p, int nr_p)
#else
...
#endif /* WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    register byte* tmp asm ("9") = (byte*)tmp_p;
    register int nr asm ("10") = (int)nr_p;
    register word32* L_AES_PPC64_td_c asm ("11") = (word32*)&L_AES_PPC64_td;
    register byte* L_AES_PPC64_td4_c asm ("12") = (byte*)&L_AES_PPC64_td4;
    register word32* L_AES_PPC64_te4_0_c asm ("14") =
        (word32*)&L_AES_PPC64_te4_0;
#else
    register word32* L_AES_PPC64_td_c = (word32*)&L_AES_PPC64_td;
    register byte* L_AES_PPC64_td4_c = (byte*)&L_AES_PPC64_td4;
    ...
    "L_AES_XTS_decrypt_done_data_%=: \n\t"
        ...
        : [in] "+r" (in), [out] "+r" (out), [sz] "+r" (sz), [i] "+r" (i),
          ...
          [L_AES_PPC64_te4_0] "+r" (L_AES_PPC64_te4_0_c)
        :
        : "memory", "cc", "0", "15", "16", "17", "18", "19", "20", "21", "22",
