...
#endif /* NEED_SOFTWARE_AES_SETKEY */
...
#if !defined(FREESCALE_LTC_AES_GCM) && !defined(WOLF_CRYPTO_CB_ONLY_AES)
    if (ret == 0) {
        VECTOR_REGISTERS_PUSH;
...
#endif /* !FREESCALE_LTC_AES_GCM && !WOLF_CRYPTO_CB_ONLY_AES */
...
#endif /* !FREESCALE_LTC_AES_GCM */
#endif /* !WOLFSSL_XILINX_CRYPT && !WOLFSSL_AFALG_XILINX_AES */
...
#endif /* HAVE_AES_DECRYPT */
#endif /* (WOLFSSL_AES_CFB || WOLFSSL_AES_OFB) */
