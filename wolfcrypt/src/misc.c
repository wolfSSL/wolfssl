...
WC_STATIC WC_INLINE void ForceZero(void* mem, word32 len)
{
    ...
    volatile word64* w;
        ...
        while (l--) *z++ = 0;
    #endif
    for (w = (volatile word64*)z; len >= (word32)sizeof(*w);
         len -= (word32)sizeof(*w))
        *w++ = 0;
    z = (volatile byte*)w;
#endif
...
{
    c[0] = (byte)((word32)((wc_u32 >> 24) & 0xff));
    c[1] = (byte)((word32)((wc_u32 >> 16) & 0xff));
    c[2] = (byte)((word32)((wc_u32 >>  8) & 0xff));
    c[3] = (byte)((word32)(wc_u32 & 0xff));
}
#endif
...
{
    *wc_u32 = ((word32)wc_u24[0] << 16) | ((word32)wc_u24[1] << 8) |
               (word32)wc_u24[2];
}
...
{
    *wc_u24 = ((word32)c[0] << 16) | ((word32)c[1] << 8) |
               (word32)c[2];
}
...
{
    *wc_u32 = ((word32)c[0] << 24) | ((word32)c[1] << 16) |
