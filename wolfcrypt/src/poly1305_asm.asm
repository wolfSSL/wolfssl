...
poly1305_setkey_avx PROC
        push	r12
        push	r13
        movabsq	r12, 1152921487695413247
        movabsq	r13, 1152921487695413244
...
L_poly1305_avx_blocks_start:
        ...
        mul	r9
        ;   r[0] * h[2] +> t2
        add	r13, QWORD PTR [rcx+8*r10+360]
        mov	r14, rdx
        add	r12, r8
        adc	r13, rax
        ;   r[1] * h[2] +> t3
        adc	r14, QWORD PTR [rcx+8*r10+416]
        ; r * h in r14, r13, r12, r11
        ; h = (r * h) mod 2^130 - 5
        mov	r10, r13
        and	r13, -4
...
poly1305_blocks_avx2 PROC
        ...
        vmovdqu	ymm4, ptr_L_poly1305_avx2_blocks_hibit
        vpsllq	ymm1, ymm1, 6
        vpsllq	ymm2, ymm2, 12
        vpsllq	ymm3, ymm3, 18
        vmovdqu	ymm14, ptr_L_poly1305_avx2_blocks_mask
...
L_poly1305_avx2_blocks_begin_h:
        ...
        vmovdqu	ymm8, YMMWORD PTR [rcx+224]
...
L_poly1305_avx2_blocks_load_r4:
        ...
        vmovdqu	ymm13, YMMWORD PTR [rcx+320]
        vpermq	ymm5, ymm13, 0
...
L_poly1305_avx2_blocks_start:
        ...
        vmovdqu	ymm9, ptr_L_poly1305_avx2_blocks_hibit
        vpsllq	ymm6, ymm6, 6
        vpsllq	ymm7, ymm7, 12
        vpsllq	ymm8, ymm8, 18
...
L_poly1305_avx2_blocks_end_calc:
        ...
        mov	QWORD PTR [rcx+40], rcx
L_poly1305_avx2_blocks_complete:
        mov	BYTE PTR [rcx+617], 1
...
poly1305_final_avx2 PROC
        mov	r8, rcx
        mov	r9, rdx
        mov	BYTE PTR [r8+616], 1
        mov	cl, BYTE PTR [r8+617]
        cmp	rcx, 0
...
L_poly1305_avx2_final_cmp_copy:
        ...
        vmovdqu	YMMWORD PTR [r8+160], ymm0
        vmovdqu	YMMWORD PTR [r8+192], ymm0
        vmovdqu	YMMWORD PTR [r8+224], ymm0
        vmovdqu	YMMWORD PTR [r8+256], ymm0
        vmovdqu	YMMWORD PTR [r8+288], ymm0
        vmovdqu	YMMWORD PTR [r8+320], ymm0
        mov	QWORD PTR [r8+608], 0
        movw	[r8+616], 0
        ret
