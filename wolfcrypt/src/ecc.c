                     ...
                     ecc_key* key, mp_int *r, mp_int *s)
{
   ...
   if (err == MP_OKAY) {
       WC_DECLARE_VAR(pubkey, ecc_key, 1);
                            ...
                            word32* outLen)
{
    int    ret = MP_OKAY;
    word32 numlen;
    WC_DECLARE_VAR(buf, byte, ECC_BUFSIZE);
...
#endif
    word32       pubKeySz = 0;
    WC_DECLARE_VAR(peerKey, ecc_key, 1);
#endif
    word32       digestSz = 0;
    ecEncCtx     localCtx;
#ifdef WOLFSSL_SMALL_STACK
