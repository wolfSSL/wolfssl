...
/*!
    ...
    non-digit character or leading zero, fewer than two arcs, first arc > 2,
    or a second arc >= 40 when the first arc is 0 or 1)
...
/*!
    ...
    due to representation limits or exceeding MAX_CERTPOL_NB.
