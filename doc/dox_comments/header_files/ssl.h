...
/*!
    ...
    certificate signing, 5 only a netscape certificate type said so.  The three
    TLS purposes - SSL client, SSL server and netscape SSL server - report only
    1 or 0 and never the code behind it, which is what OpenSSL does for them.
