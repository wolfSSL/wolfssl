...
/*!
    ...
    parsing this WOLFSSL_X509 due to representation limits or exceeding
    MAX_CERTPOL_NB. Only available in builds with WOLFSSL_CERT_EXT and
    one of KEEP_PEER_CERT, SESSION_CERTS, OPENSSL_EXTRA or
