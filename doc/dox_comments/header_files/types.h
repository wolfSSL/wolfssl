...
/*!
    \ingroup Memory
    \brief Debug version of XFREE with file/line tracking.
    ...
    _Example_
    \code
    int* ptr = XMALLOC(sizeof(int), NULL, DYNAMIC_TYPE_TMP_BUFFER);
    xfree(ptr, NULL, DYNAMIC_TYPE_TMP_BUFFER, __func__, __FILE__,
          __LINE__);
    \endcode

    \sa XFREE
*/
void xfree(void *p, void* heap, int type, const char* func,
