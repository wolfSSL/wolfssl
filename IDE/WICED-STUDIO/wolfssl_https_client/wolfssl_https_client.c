...
#ifdef WOLFSSL_WICED_USE_WOLF_SERVER
#if defined(WOLFSSL_WICED_STATIC_CA)
...
#endif  /* WOLFSSL_WICED_USE_WOLF_SERVER */
...
{
#ifndef WOLFSSL_WICED_USE_WOLF_SERVER
    ...
    if (wiced_tls_init_root_ca_certificates(
        (const char*)http_root_ca_certificate,
        (uint32_t)http_root_ca_certificate_lg) != WICED_SUCCESS)
    {
    ...
    client_configuration.flag = (http_client_configuration_flags_t)
        (HTTP_CLIENT_CONFIG_FLAG_SERVER_NAME |
