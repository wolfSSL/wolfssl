...
NAME := wolfssl_tls_client

$(NAME)_SOURCES := wolfssl_tls_client.c
...
# this application shows the functionality of using a single certificate.
...
ifeq (1, ${ECC_CERT})
	GLOBAL_DEFINES     += WOLFSSL_WICED_USE_ECC_CERT
else
	GLOBAL_DEFINES     += WOLFSSL_WICED_USE_RSA_CERT
endif
