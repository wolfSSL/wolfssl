...
The `wolfsslRunTests.c` example application provides a simple function to run the selected test_apps at compile time through the following four #defines in user_settings.h.
...
$ ./test_apps/client/client.exe -h TLS_SERVER_IP_ADDRES
