...
/* Purpose identifiers.  These match OpenSSL's values, so an application that
 * stores or compares the number behaves the same either way.
 *
 * NOTE: SSL_CLIENT and SSL_SERVER used to be 0 and 1 here, which matched
 * neither OpenSSL nor X509_check_purpose()'s reserved -1 "no purpose". */
#define WOLFSSL_X509_PURPOSE_SSL_CLIENT       1
#define WOLFSSL_X509_PURPOSE_SSL_SERVER       2
#define WOLFSSL_X509_PURPOSE_NS_SSL_SERVER    3
#define WOLFSSL_X509_PURPOSE_SMIME_SIGN       4
#define WOLFSSL_X509_PURPOSE_SMIME_ENCRYPT    5
#define WOLFSSL_X509_PURPOSE_CRL_SIGN         6
#define WOLFSSL_X509_PURPOSE_ANY              7
#define WOLFSSL_X509_PURPOSE_OCSP_HELPER      8
#define WOLFSSL_X509_PURPOSE_TIMESTAMP_SIGN   9
#define WOLFSSL_X509_PURPOSE_CODE_SIGN        10
#define WOLFSSL_X509_PURPOSE_MIN              1
#define WOLFSSL_X509_PURPOSE_MAX              10
...
#define X509_PURPOSE_NS_SSL_SERVER    WOLFSSL_X509_PURPOSE_NS_SSL_SERVER
#define X509_PURPOSE_SMIME_SIGN       WOLFSSL_X509_PURPOSE_SMIME_SIGN
#define X509_PURPOSE_SMIME_ENCRYPT    WOLFSSL_X509_PURPOSE_SMIME_ENCRYPT
#define X509_PURPOSE_CRL_SIGN         WOLFSSL_X509_PURPOSE_CRL_SIGN
#define X509_PURPOSE_ANY              WOLFSSL_X509_PURPOSE_ANY
#define X509_PURPOSE_OCSP_HELPER      WOLFSSL_X509_PURPOSE_OCSP_HELPER
#define X509_PURPOSE_TIMESTAMP_SIGN   WOLFSSL_X509_PURPOSE_TIMESTAMP_SIGN
#define X509_PURPOSE_CODE_SIGN        WOLFSSL_X509_PURPOSE_CODE_SIGN
#define X509_PURPOSE_MIN              WOLFSSL_X509_PURPOSE_MIN
#define X509_PURPOSE_MAX              WOLFSSL_X509_PURPOSE_MAX
