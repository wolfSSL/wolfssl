 ...
 * software.
 *
 * WOLFSSL_WOLFHAL_RNG additionally builds wc_wolfHAL_GenerateBlock(). Wiring
 * it in as the entropy source is left to user_settings.h, since it needs a
 * prototype visible to random.c:
 ...
 * through this device by giving their devId the wolfHAL value. */
#ifndef WC_USE_DEVID
