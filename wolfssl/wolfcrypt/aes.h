 ...
 * above; the running tweak is read from and written back to "tweak"
 * instead of being derived from an IV under key2.  sz must be at least one
 * block; the callers in aes.c reject anything shorter before dispatching. */
