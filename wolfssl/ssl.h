...
CYASSL_API CYASSL_METHOD *wolfSSLv3_server_method(void);
CYASSL_API CYASSL_METHOD *wolfSSLv3_client_method(void);
CYASSL_API CYASSL_METHOD *wolfTLSv1_server_method(void);  
CYASSL_API CYASSL_METHOD *wolfTLSv1_client_method(void);
CYASSL_API CYASSL_METHOD *wolfTLSv1_1_server_method(void);  
CYASSL_API CYASSL_METHOD *wolfTLSv1_1_client_method(void);
CYASSL_API CYASSL_METHOD *wolfTLSv1_2_server_method(void);  
CYASSL_API CYASSL_METHOD *wolfTLSv1_2_client_method(void);

#ifdef CYASSL_DTLS
    CYASSL_API CYASSL_METHOD *wolfDTLSv1_client_method(void);
    CYASSL_API CYASSL_METHOD *wolfDTLSv1_server_method(void);
    CYASSL_API CYASSL_METHOD *wolfDTLSv1_2_client_method(void);
    CYASSL_API CYASSL_METHOD *wolfDTLSv1_2_server_method(void);
#endif
