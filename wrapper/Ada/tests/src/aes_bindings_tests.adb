...
package body AES_Bindings_Tests is
   ...
   begin
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_Key(encrypt) failed, Result =" & Integer'Image (R));
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_IV(encrypt) failed, Result =" & Integer'Image (R));
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_Cbc_Encrypt failed, Result =" & Integer'Image (R));
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_Key(decrypt) failed, Result =" & Integer'Image (R));
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_IV(decrypt) failed, Result =" & Integer'Image (R));
      ...
      AUnit.Assertions.Assert
        (R = 0,
         "AES_Set_Cbc_Decrypt failed, Result =" & Integer'Image (R));
