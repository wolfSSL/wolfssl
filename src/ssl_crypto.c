    ...
    unsigned char* hash)
{
    ...
    WC_DECLARE_VAR(sha224, wc_Sha224, 1);
    int ret = 0;
    ...
    unsigned char* hash)
{
    ...
    WC_DECLARE_VAR(sha256, wc_Sha256, 1);
    int ret = 0;
    ...
    unsigned char* hash)
{
    ...
    WC_DECLARE_VAR(sha384, wc_Sha384, 1);
    int ret = 0;
    ...
    unsigned char* hash)
{
    ...
    WC_DECLARE_VAR(sha512, wc_Sha512, 1);
    int ret = 0;
