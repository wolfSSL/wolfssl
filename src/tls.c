...
int DeriveTlsKeys(WOLFSSL* ssl)
{
    ...
    int   key_dig_len = 2 * ssl->specs.hash_size +
                        ...
                        2 * ssl->specs.iv_size;
    WC_DECLARE_VAR(key_dig, byte, MAX_PRF_DIG);
...
{
    int   ret;
    WC_DECLARE_VAR(seed, byte, SEED_LEN);
    ...
    word16* pLength)
{
    ...
    WC_DECLARE_VAR(tmpServerName, char, MAX_PUBLIC_NAME_SZ);
