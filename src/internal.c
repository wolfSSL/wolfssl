...
#ifdef BUILD_TLS_PSK_WITH_AES_256_CCM_8
    {"PSK-AES256-CCM-8", TLS_PSK_WITH_AES_256_CCM_8},
#endif
...
#ifdef BUILD_TLS_RSA_WITH_HC_128_MD5
    {"HC128-MD5", TLS_RSA_WITH_HC_128_MD5},
#endif

#ifdef BUILD_TLS_RSA_WITH_HC_128_SHA
    {"HC128-SHA", TLS_RSA_WITH_HC_128_SHA},
#endif

#ifdef BUILD_TLS_RSA_WITH_HC_128_B2B256
    {"HC128-B2B256", TLS_RSA_WITH_HC_128_B2B256},
#endif

#ifdef BUILD_TLS_RSA_WITH_AES_128_CBC_B2B256
    {"AES128-B2B256", TLS_RSA_WITH_AES_128_CBC_B2B256},
#endif

#ifdef BUILD_TLS_RSA_WITH_AES_256_CBC_B2B256
    {"AES256-B2B256", TLS_RSA_WITH_AES_256_CBC_B2B256},
#endif

#ifdef BUILD_TLS_RSA_WITH_RABBIT_SHA
    {"RABBIT-SHA", TLS_RSA_WITH_RABBIT_SHA},
#endif

#ifdef BUILD_TLS_NTRU_RSA_WITH_RC4_128_SHA
    {"NTRU-RC4-SHA", TLS_NTRU_RSA_WITH_RC4_128_SHA},
#endif
...
#ifdef BUILD_TLS_NTRU_RSA_WITH_AES_128_CBC_SHA
    {"NTRU-AES128-SHA", TLS_NTRU_RSA_WITH_AES_128_CBC_SHA},
#endif

#ifdef BUILD_TLS_NTRU_RSA_WITH_AES_256_CBC_SHA
    {"NTRU-AES256-SHA", TLS_NTRU_RSA_WITH_AES_256_CBC_SHA},
#endif
...
#ifdef BUILD_TLS_RSA_WITH_AES_256_CCM_8
    {"AES256-CCM-8", TLS_RSA_WITH_AES_256_CCM_8},
#endif
...
#ifdef BUILD_TLS_ECDHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256
    {"ECDHE-RSA-CHACHA20-POLY1305-OLD", TLS_ECDHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256},
#endif
...
#ifdef BUILD_TLS_DHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256
    {"DHE-RSA-CHACHA20-POLY1305-OLD", TLS_DHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256},
#endif
...
#ifdef HAVE_RENEGOTIATION_INDICATION
    {"RENEGOTIATION-INFO", TLS_EMPTY_RENEGOTIATION_INFO_SCSV},
#endif
    ...
    do {
        ...
        for (i = 0; i < suiteSz; i++) {
            if (XSTRNCMP(name, cipher_names[i].name, sizeof(name)) == 0) {
                ...
                suites->suites[idx++] = (byte)cipher_names[i].idx;
...
int GetCipherIANAList(Suites* suites, byte* buf, int len, int* num_ids)
{
    ...
    if (suites == NULL || buf == NULL || num_ids == NULL) {
