...
#ifdef BUILD_TLS_RSA_WITH_HC_128_B2B256
    SUITE_INFO("HC128-B2B256","TLS_RSA_WITH_HC_128_B2B256",CIPHER_BYTE,TLS_RSA_WITH_HC_128_B2B256,TLSv1_MINOR,SSLv3_MAJOR),
#endif

#ifdef BUILD_TLS_RSA_WITH_AES_128_CBC_B2B256
    SUITE_INFO("AES128-B2B256","TLS_RSA_WITH_AES_128_CBC_B2B256",CIPHER_BYTE,TLS_RSA_WITH_AES_128_CBC_B2B256,TLSv1_MINOR,SSLv3_MAJOR),
#endif

#ifdef BUILD_TLS_RSA_WITH_AES_256_CBC_B2B256
    SUITE_INFO("AES256-B2B256","TLS_RSA_WITH_AES_256_CBC_B2B256",CIPHER_BYTE,TLS_RSA_WITH_AES_256_CBC_B2B256,TLSv1_MINOR,SSLv3_MAJOR),
#endif
...
const char* GetCipherKeaStr(const char n0[],const char n1[],const char n2[],
    ...
    if ((XSTRNCMP(n0,"ECDHE",5) == 0 && XSTRNCMP(n1, "PSK",3) != 0)
        ...
        keaStr = "EDH";
             ...
             (XSTRNCMP(n2,"RSA",3) == 0) ||
             (XSTRNCMP(n0,"AES128",6) == 0) || (XSTRNCMP(n0, "AES256",6) == 0)
             || (XSTRNCMP(n1,"MD5",3) == 0))
        keaStr = "RSA";
    else
        keaStr = "unknown";
...
const char* GetCipherAuthStr(const char n0[],const char n1[],const char n2[],
                             const char n3[],const char n4[]) {
...
const char* GetCipherEncStr(const char n0[],const char n1[],const char n2[],
                            const char n3[],const char n4[]) {
    ...
    else if ((XSTRNCMP(n0,"AES128",6) == 0) ||(XSTRNCMP(n2,"AES128",6) == 0)
            || (XSTRNCMP(n1,"AES",3) == 0 && XSTRNCMP(n2,"128",3) == 0)
            || (XSTRNCMP(n2,"AES",3) == 0 && XSTRNCMP(n3,"128",3) == 0))
        encStr = "AES(128)";

    else if ((XSTRNCMP(n0,"AES256",6) == 0) || (XSTRNCMP(n2,"AES256",6) == 0)
...
const char* GetCipherMacStr(const char n0[],const char n1[],const char n2[],
                            const char n3[],const char n4[]) {
