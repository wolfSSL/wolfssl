...
{
    WC_DECLARE_VAR(info, EncryptedInfo, 1);
...
int wolfSSL_DSA_generate_key(WOLFSSL_DSA* dsa)
{
...
#ifdef WOLFSSL_KEY_GEN
    {
        int initTmpRng = 0;
        WC_RNG *rng = NULL;
        WC_DECLARE_VAR(tmpRng, WC_RNG, 1);
    ...
    WOLFSSL_EC_POINT *point)
{
    int err = 0;
    mp_digit mp = 0;
    WC_DECLARE_VAR(modulus, mp_int, 1);
    ...
    WOLFSSL_EC_KEY *key)
{
    ...
    WC_DECLARE_VAR(out, byte, ECC_BUFSIZE);
