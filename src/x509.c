...
int wolfSSL_X509_CRL_set_lastUpdate(WOLFSSL_X509_CRL* crl, WOLFSSL_ASN1_TIME* time)
{
...
int wolfSSL_X509_CRL_set_nextUpdate(WOLFSSL_X509_CRL* crl, WOLFSSL_ASN1_TIME* time)
{
    if (crl != NULL && crl->crlList != NULL && time != NULL) {
