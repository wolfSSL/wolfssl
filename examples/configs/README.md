...
* `user_settings_fipsv5.h`: The FIPS v5 (ready) 140-3 build options. Generated from `./configure --enable-fips=v5-dev`, a flavor retired in 2026-08; the surviving v5 build is `--enable-fips=v5`.
