/* test_sp_arm32_fault_whitebox.c
 *
...
/*
 * Heap-fault MC/DC supplement for wolfcrypt/src/sp_arm32.c, run inside this
...
/* Before ANY wolfSSL header, so sp_arm32.c's own
...
#define SP_ARM_FAULT_LABEL "sp_arm32.c"
