...
#define TEST_MLDSA_DECLS                                                     \
    ...
    TEST_DECL_GROUP("mldsa", test_mldsa_pkcs8_export_import_wolfSSL_format), \
    TEST_DECL_GROUP("mldsa", test_wc_Dilithium_PrivateKeyDecode_OpenSSL_format), \
    TEST_DECL_GROUP("mldsa", test_mldsa_pkcs8_import_OpenSSL_format),        \
