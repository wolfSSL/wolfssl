 ...
 */
    ...
    /* Buffer sized to exactly fit "2.16.840.1.101.3.4.2.1\0" (22 chars +
     * NUL) must succeed -- pins the success side of the same boundary the
     * cases above pin from the failure side. */
    {
        char exactBuf[23];
