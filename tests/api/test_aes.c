...
int test_wc_AesCtsEncryptDecrypt(void)
{
    ...
    /* Execute all branches */
    {
        ...
        byte* out = tmp;
        word32 outSz = vects[5].outLen;
        word32 remSz = vects[5].outLen;
    ...
    }
    {
        ...
        byte* out = tmp;
        word32 outSz = vects[2].outLen;
        word32 remSz = vects[2].outLen;
    ...
    }
    {
        ...
        byte* out = tmp;
        word32 outSz = vects[5].inLen;
        word32 remSz = vects[5].inLen;
    ...
    }
    {
        ...
        byte* out = tmp;
        word32 outSz = vects[2].inLen;
        word32 remSz = vects[2].inLen;
