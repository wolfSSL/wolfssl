...
#define TEST_TLS13_DECLS                                        \
    ...
    TEST_DECL_GROUP("tls13", test_tls13_ctx_cert_rotation_refused), \
    TEST_DECL_GROUP("tls13", test_tls13_sni_cb_cert_change_refused), \
    TEST_DECL_GROUP("tls13", test_tls13_ctx_dh_change_refused), \
