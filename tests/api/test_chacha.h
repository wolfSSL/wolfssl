...
#define TEST_CHACHA_DECLS                                        \
    ...
    TEST_DECL_GROUP("chacha", test_wc_ChachaBadArgCoverage),     \
    TEST_DECL_GROUP("chacha", test_wc_ChachaDecisionCoverage),   \
    TEST_DECL_GROUP("chacha", test_wc_ChachaEncryptBytesCoverage)
