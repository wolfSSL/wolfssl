...
static int test_wolfSSL_Init(void)
{
    ...
    result = wolfSSL_Init();
    printf(resultFmt, result == WOLF_SSL_SUCCESS ? passed : failed);
...
#ifdef NO_RSA
    /* rsa needed */
    AssertFalse(wolfSSL_CTX_use_certificate_file(ctx, svrCertFile,WOLF_SSL_FILETYPE_PEM));
#else
    /* success */
    AssertTrue(wolfSSL_CTX_use_certificate_file(ctx, svrCertFile, WOLF_SSL_FILETYPE_PEM));
#endif
...
static int test_wolfSSL_CTX_use_certificate_buffer(void)
{
        ...
        ret = wolfSSL_CTX_use_certificate_buffer(ctx, server_cert_der_2048,
                    sizeof_server_cert_der_2048, WOLF_SSL_FILETYPE_ASN1);

        printf(resultFmt, ret == WOLF_SSL_SUCCESS ? passed : failed);
        wolfSSL_CTX_free(ctx);
...
#ifdef NO_RSA
    /* rsa needed */
    AssertFalse(wolfSSL_CTX_use_PrivateKey_file(ctx, svrKeyFile, WOLF_SSL_FILETYPE_PEM));
#else
    /* success */
...
static void test_wolfSSL_CTX_trust_peer_cert(void)
{
    ...
    /* success */
    assert(wolfSSL_CTX_trust_peer_cert(ctx, cliCertFile, WOLF_SSL_FILETYPE_PEM)
                                                                == WOLF_SSL_SUCCESS);

    /* unload cert */
    assert(wolfSSL_CTX_Unload_trust_peers(NULL) != WOLF_SSL_SUCCESS);
    assert(wolfSSL_CTX_Unload_trust_peers(ctx) == WOLF_SSL_SUCCESS);
#endif
    ...
    assert(wolfSSL_CTX_trust_peer_buffer(ctx, client_cert_der_1024,
                sizeof_client_cert_der_1024, WOLF_SSL_FILETYPE_ASN1) == WOLF_SSL_SUCCESS);
#endif
#ifdef USE_CERT_BUFFERS_2048
    assert(wolfSSL_CTX_trust_peer_buffer(ctx, client_cert_der_2048,
                sizeof_client_cert_der_2048, WOLF_SSL_FILETYPE_ASN1) == WOLF_SSL_SUCCESS);
#endif
...
static void test_wolfSSL_CTX_load_verify_locations(void)
{
    ...
    /* invalid ca file */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_load_verify_locations(ctx, NULL,      0));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_load_verify_locations(ctx, bogusFile, 0));
...
static void test_wolfSSL_CTX_SetTmpDH_file(void)
{
    ...
    /* invalid context */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_file(NULL,
                dhParamFile, WOLF_SSL_FILETYPE_PEM));

    /* invalid dhParamFile file */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_file(ctx,
                NULL, WOLF_SSL_FILETYPE_PEM));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_file(ctx,
                bogusFile, WOLF_SSL_FILETYPE_PEM));

    /* success */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_file(ctx, dhParamFile,
                WOLF_SSL_FILETYPE_PEM));
...
static void test_wolfSSL_CTX_SetTmpDH_buffer(void)
{
    ...
    /* invalid context */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_buffer(NULL, dh_key_der_2048,
                sizeof_dh_key_der_2048, WOLF_SSL_FILETYPE_ASN1));

    /* invalid dhParamFile file */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_buffer(NULL, NULL,
                0, WOLF_SSL_FILETYPE_ASN1));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_buffer(ctx, dsa_key_der_2048,
                sizeof_dsa_key_der_2048, WOLF_SSL_FILETYPE_ASN1));

    /* success */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_SetTmpDH_buffer(ctx, dh_key_der_2048,
                sizeof_dh_key_der_2048, WOLF_SSL_FILETYPE_ASN1));
...
static void test_wolfSSL_SetTmpDH_file(void)
{
    ...
    /* invalid ssl */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_file(NULL,
                dhParamFile, WOLF_SSL_FILETYPE_PEM));

    /* invalid dhParamFile file */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_file(ssl,
                NULL, WOLF_SSL_FILETYPE_PEM));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_file(ssl,
                bogusFile, WOLF_SSL_FILETYPE_PEM));

    /* success */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_file(ssl, dhParamFile,
                WOLF_SSL_FILETYPE_PEM));
...
static void test_wolfSSL_SetTmpDH_buffer(void)
{
    ...
    AssertTrue(wolfSSL_CTX_use_PrivateKey_buffer(ctx, server_key_der_2048,
                sizeof_server_key_der_2048, WOLF_SSL_FILETYPE_ASN1));
    AssertNotNull(ssl = wolfSSL_new(ctx));

    /* invalid ssl */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_buffer(NULL, dh_key_der_2048,
                sizeof_dh_key_der_2048, WOLF_SSL_FILETYPE_ASN1));

    /* invalid dhParamFile file */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_buffer(NULL, NULL,
                0, WOLF_SSL_FILETYPE_ASN1));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_buffer(ssl, dsa_key_der_2048,
                sizeof_dsa_key_der_2048, WOLF_SSL_FILETYPE_ASN1));

    /* success */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_SetTmpDH_buffer(ssl, dh_key_der_2048,
                sizeof_dh_key_der_2048, WOLF_SSL_FILETYPE_ASN1));
...
static int test_wolfSSL_SetMinVersion(void)
{
    ...
    for (itr = 0; itr < (int)(sizeof(versions)/sizeof(int)); itr++){
       if(wolfSSL_SetMinVersion(ssl, *(versions + itr)) != WOLF_SSL_SUCCESS){
            failFlag = WOLF_SSL_FAILURE;
        }
    }

    printf(resultFmt, failFlag == WOLF_SSL_SUCCESS ? passed : failed);
...
static THREAD_RETURN WOLFSSL_THREAD test_server_nofail(void* args)
{
    ...
    wolfSSL_CTX_set_verify(ctx,
                          WOLF_SSL_VERIFY_PEER | WOLF_SSL_VERIFY_FAIL_IF_NO_PEER_CERT, 0);

#ifdef OPENSSL_EXTRA
    wolfSSL_CTX_set_default_passwd_cb(ctx, PasswordCallBack);
#endif

    if (wolfSSL_CTX_load_verify_locations(ctx, cliCertFile, 0) != WOLF_SSL_SUCCESS)
    {
        /*err_sys("can't load ca file, Please run from wolfSSL home dir");*/
        goto done;
    }
    if (wolfSSL_CTX_use_certificate_file(ctx, svrCertFile, WOLF_SSL_FILETYPE_PEM)
            != WOLF_SSL_SUCCESS)
    {
    ...
    if (wolfSSL_CTX_use_PrivateKey_file(ctx, svrKeyFile, WOLF_SSL_FILETYPE_PEM)
            != WOLF_SSL_SUCCESS)
    {
    ...
    if (wolfSSL_set_fd(ssl, clientfd) != WOLF_SSL_SUCCESS) {
...
static void test_client_nofail(void* args)
{
    ...
    if (wolfSSL_CTX_load_verify_locations(ctx, caCertFile, 0) != WOLF_SSL_SUCCESS)
    {
        /* err_sys("can't load ca file, Please run from wolfSSL home dir");*/
        goto done2;
    }
    if (wolfSSL_CTX_use_certificate_file(ctx, cliCertFile, WOLF_SSL_FILETYPE_PEM)
            != WOLF_SSL_SUCCESS)
    {
    ...
    if (wolfSSL_CTX_use_PrivateKey_file(ctx, cliKeyFile, WOLF_SSL_FILETYPE_PEM)
            != WOLF_SSL_SUCCESS)
    {
...
static THREAD_RETURN WOLFSSL_THREAD run_wolfssl_server(void* args)
{
...
#endif
#ifdef WOLFSSL_SESSION_EXPORT
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_dtls_set_export(ctx, test_export));
#endif


    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_load_verify_locations(ctx, cliCertFile, 0));
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_set_fd(ssl, cfd));
...
static void run_wolfssl_client(void* args)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_load_verify_locations(ctx, caCertFile, 0));

    AssertIntEQ(WOLF_SSL_SUCCESS,
               wolfSSL_CTX_use_certificate_file(ctx, cliCertFile, WOLF_SSL_FILETYPE_PEM));

    AssertIntEQ(WOLF_SSL_SUCCESS,
                 wolfSSL_CTX_use_PrivateKey_file(ctx, cliKeyFile, WOLF_SSL_FILETYPE_PEM));
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_set_fd(ssl, sfd));
...
static void test_wolfSSL_UseSNI_params(void)
{
    ...
    /* invalid [ctx|ssl] */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseSNI(NULL, 0, "ctx", 3));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseSNI(    NULL, 0, "ssl", 3));
    /* invalid type */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseSNI(ctx, -1, "ctx", 3));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseSNI(    ssl, -1, "ssl", 3));
    /* invalid data */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseSNI(ctx,  0, NULL,  3));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseSNI(    ssl,  0, NULL,  3));
    /* success case */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseSNI(ctx,  0, "ctx", 3));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseSNI(    ssl,  0, "ssl", 3));
...
static void test_wolfSSL_SNI_GetFromBuffer(void)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_SNI_GetFromBuffer(buffer, sizeof(buffer),
                                                           0, result, &length));
    result[length] = 0;
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_SNI_GetFromBuffer(buffer2, sizeof(buffer2),
                                                           0, result, &length));
    result[length] = 0;
...
static void test_wolfSSL_UseMaxFragment(void)
{
    ...
    /* error cases */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(NULL, WOLFSSL_MFL_2_9));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    NULL, WOLFSSL_MFL_2_9));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx, 0));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx, 6));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(ssl, 0));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(ssl, 6));

    /* success case */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx,  WOLFSSL_MFL_2_9));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx,  WOLFSSL_MFL_2_10));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx,  WOLFSSL_MFL_2_11));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx,  WOLFSSL_MFL_2_12));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseMaxFragment(ctx,  WOLFSSL_MFL_2_13));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    ssl,  WOLFSSL_MFL_2_9));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    ssl,  WOLFSSL_MFL_2_10));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    ssl,  WOLFSSL_MFL_2_11));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    ssl,  WOLFSSL_MFL_2_12));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseMaxFragment(    ssl,  WOLFSSL_MFL_2_13));
...
static void test_wolfSSL_UseTruncatedHMAC(void)
{
    ...
    /* error cases */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseTruncatedHMAC(NULL));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseTruncatedHMAC(NULL));

    /* success case */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseTruncatedHMAC(ctx));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseTruncatedHMAC(ssl));
...
static void test_wolfSSL_UseSupportedCurve(void)
{
    ...
    /* error cases */
    AssertIntNE(WOLF_SSL_SUCCESS,
                      wolfSSL_CTX_UseSupportedCurve(NULL, WOLFSSL_ECC_SECP256R1));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_UseSupportedCurve(ctx,  0));

    AssertIntNE(WOLF_SSL_SUCCESS,
                          wolfSSL_UseSupportedCurve(NULL, WOLFSSL_ECC_SECP256R1));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseSupportedCurve(ssl,  0));
...
static void use_ALPN_all(WOLFSSL* ssl)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseALPN(ssl, alpn_list, sizeof(alpn_list),
...
static void use_ALPN_one(WOLFSSL* ssl)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseALPN(ssl, proto, sizeof(proto),
                                             WOLFSSL_ALPN_FAILED_ON_MISMATCH));
}
...
static void verify_ALPN_not_matching_spdy3(WOLFSSL* ssl)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_ALPN_GetProtocol(ssl, &proto, &protoSz));
...
static void verify_ALPN_client_list(WOLFSSL* ssl)
{
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_ALPN_GetPeerProtocol(ssl, &clist,
                                                          &clistSz));
    ...
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_ALPN_FreePeerProtocol(ssl, &clist));
}
...
static void test_wolfSSL_UseALPN_params(void)
{
    ...
    AssertIntNE(WOLF_SSL_SUCCESS,
                wolfSSL_UseALPN(NULL, http1, sizeof(http1),
                                WOLFSSL_ALPN_FAILED_ON_MISMATCH));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_UseALPN(ssl, NULL, 0,
                                             WOLFSSL_ALPN_FAILED_ON_MISMATCH));
    ...
    idx += sizeof(spdy1);
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_UseALPN(ssl, buff, idx,
                                             WOLFSSL_ALPN_FAILED_ON_MISMATCH));
...
static void test_wolfSSL_DisableExtendedMasterSecret(void)
{
    ...
    /* error cases */
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_CTX_DisableExtendedMasterSecret(NULL));
    AssertIntNE(WOLF_SSL_SUCCESS, wolfSSL_DisableExtendedMasterSecret(NULL));

    /* success cases */
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_CTX_DisableExtendedMasterSecret(ctx));
    AssertIntEQ(WOLF_SSL_SUCCESS, wolfSSL_DisableExtendedMasterSecret(ssl));
...
static void test_wolfSSL_X509_NAME_get_entry(void)
{
...

    {
        ...
        x509 = wolfSSL_X509_load_certificate_file(cliCertFile, WOLF_SSL_FILETYPE_PEM);
        AssertNotNull(x509);
...
static int test_wolfSSL_CTX_SetMinVersion(void)
{
    ...
    for (itr = 0; itr < (int)(sizeof(versions)/sizeof(int)); itr++){
        if(wolfSSL_CTX_SetMinVersion(ctx, *(versions + itr)) != WOLF_SSL_SUCCESS){
            failFlag = WOLF_SSL_FAILURE;
        }
    }
...
static void test_wolfSSL_mcast(void)
{
    ...
    AssertIntEQ(result, WOLF_SSL_SUCCESS);
...
static int test_wc_AesCbcEncryptDecrypt (void)
{
    ...
    int     cbcE    =   WOLF_SSL_FATAL_ERROR;
    int     cbcD    =   WOLF_SSL_FATAL_ERROR;
    int     cbcDWK  =   WOLF_SSL_FATAL_ERROR;
...
static int test_wc_AesGcmEncryptDecrypt (void)
{
    ...
    byte    dec[sizeof(vector)];
    int     gcmD     =   WOLF_SSL_FATAL_ERROR;
    int     gcmE     =   WOLF_SSL_FATAL_ERROR;
...
static int test_wc_CamelliaEncryptDecryptDirect (void)
{
    ...
    byte    dec[sizeof(enc)];
    int     camE = WOLF_SSL_FATAL_ERROR;
    int     camD = WOLF_SSL_FATAL_ERROR;
...
static int test_wc_CamelliaCbcEncryptDecrypt (void)
{
    ...
    int     camCbcE = WOLF_SSL_FATAL_ERROR;
    int     camCbcD = WOLF_SSL_FATAL_ERROR;
...
static int test_wc_AesCcmEncryptDecrypt (void)
{
    ...
    int ccmE = WOLF_SSL_FATAL_ERROR;
    #ifdef HAVE_AES_DECRYPT
        int ccmD = WOLF_SSL_FATAL_ERROR;
...
static int test_wc_DsaPublicPrivateKeyDecode (void)
{
    ...
    word32  bytes;
    word32  idx  = 0;
    int     priv = WOLF_SSL_FATAL_ERROR;
    int     pub  = WOLF_SSL_FATAL_ERROR;
...
static void test_wolfSSL_certs(void)
{
    ...
    AssertTrue(SSL_CTX_use_certificate_file(ctx, svrCertFile, WOLF_SSL_FILETYPE_PEM));
    AssertTrue(SSL_CTX_use_PrivateKey_file(ctx, svrKeyFile, WOLF_SSL_FILETYPE_PEM));
    AssertNotNull(ssl = SSL_new(ctx));

    AssertIntEQ(wolfSSL_check_private_key(ssl), WOLF_SSL_SUCCESS);

    #ifdef HAVE_PK_CALLBACKS
    AssertIntEQ((int)SSL_set_tlsext_debug_arg(ssl, NULL), WOLF_SSL_SUCCESS);
    #endif /* HAVE_PK_CALLBACKS */

    /* create and use x509 */
    x509 = wolfSSL_X509_load_certificate_file(cliCertFile, WOLF_SSL_FILETYPE_PEM);
    AssertNotNull(x509);
    AssertIntEQ(SSL_use_certificate(ssl, x509), WOLF_SSL_SUCCESS);

    #ifndef HAVE_USER_RSA
    /* with loading in a new cert the check on private key should now fail */
    AssertIntNE(wolfSSL_check_private_key(ssl), WOLF_SSL_SUCCESS);
    #endif
        ...
        AssertIntEQ(SSL_use_certificate_ASN1(ssl,
                                  ...
                                  sizeof_server_cert_der_2048), WOLF_SSL_SUCCESS);
    #endif
...
static void test_wolfSSL_private_keys(void)
{
    ...
    AssertIntEQ(SSL_use_RSAPrivateKey_ASN1(ssl,
                ...
                sizeof_client_key_der_2048), WOLF_SSL_SUCCESS);
#ifndef HAVE_USER_RSA
...
static void test_wolfSSL_tmp_dh(void)
{
    ...
    AssertIntEQ((int)SSL_CTX_set_tmp_dh(ctx, dh), WOLF_SSL_SUCCESS);
    AssertIntEQ((int)SSL_set_tmp_dh(ssl, dh), WOLF_SSL_SUCCESS);
...
static void test_wolfSSL_ctrl(void)
{
    ...
    AssertIntEQ((int)wolfSSL_BIO_get_mem_ptr(bio, &ptr), WOLF_SSL_SUCCESS);
...
static void test_wolfSSL_CTX_add_extra_chain_cert(void)
{
    ...
    x509 = wolfSSL_X509_load_certificate_file(caFile, WOLF_SSL_FILETYPE_PEM);
    AssertNotNull(x509);
    AssertIntEQ((int)SSL_CTX_add_extra_chain_cert(ctx, x509), WOLF_SSL_SUCCESS);

    x509 = wolfSSL_X509_load_certificate_file(clientFile, WOLF_SSL_FILETYPE_PEM);
    AssertNotNull(x509);
    AssertIntEQ((int)SSL_CTX_add_extra_chain_cert(ctx, x509), WOLF_SSL_SUCCESS);
...
static void test_wolfSSL_X509_STORE_set_flags(void)
{
    ...
    AssertNotNull((x509 =
                wolfSSL_X509_load_certificate_file(svrCertFile, WOLF_SSL_FILETYPE_PEM)));
    AssertIntEQ(X509_STORE_add_cert(store, x509), WOLF_SSL_SUCCESS);

#ifdef HAVE_CRL
    AssertIntEQ(X509_STORE_set_flags(store, WOLFSSL_CRL_CHECKALL), WOLF_SSL_SUCCESS);
#else
...
static void test_wolfSSL_X509_LOOKUP_load_file(void)
{
    ...
    AssertIntEQ(wolfSSL_CertManagerVerify(store->cm, svrCertFile,
                WOLF_SSL_FILETYPE_PEM), ASN_NO_SIGNER_E);
...
static void test_wolfSSL_BN(void)
{
    ...
    /* a^b mod c = */
    AssertIntEQ(BN_mod_exp(d, NULL, b, c, NULL), WOLF_SSL_FAILURE);
    AssertIntEQ(BN_mod_exp(d, a, b, c, NULL), WOLF_SSL_SUCCESS);

    /* check result  3^2 mod 5 */
    value[0] = 0;
    AssertIntEQ(BN_bn2bin(d, value), WOLF_SSL_SUCCESS);
...
static void test_wolfSSL_BIO(void)
{
    ...
    AssertIntEQ(BIO_set_write_buf_size(bio1, 20), WOLF_SSL_SUCCESS);
    AssertIntEQ(BIO_set_write_buf_size(bio2, 8),  WOLF_SSL_SUCCESS);
    AssertIntEQ(BIO_make_bio_pair(bio1, bio2),    WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(BIO_flush(bio1), WOLF_SSL_SUCCESS);
    ...
    /* new pair */
    AssertIntEQ(BIO_make_bio_pair(bio1, bio3), WOLF_SSL_FAILURE);
    BIO_free(bio2); /* free bio2 and automaticly remove from pair */
    AssertIntEQ(BIO_make_bio_pair(bio1, bio3), WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(BIO_nread(bio3, NULL, 0), WOLF_SSL_FAILURE);
    ...
    #if !defined(NO_FILESYSTEM)
    {
        ...
        AssertIntEQ((int)BIO_set_fp(f_bio1, f1, BIO_CLOSE), WOLF_SSL_SUCCESS);
        ...
        AssertIntEQ((int)BIO_get_fp(f_bio2, &f2), WOLF_SSL_SUCCESS);
 ...
 *----------------------------------------------------------------------------*/
        ...
        int type)
    {
        ...
        ret = wolfSSL_CertManagerVerifyBuffer(cm, cert_buf, cert_sz, WOLF_SSL_FILETYPE_ASN1);
...
static int test_tls13_apis(void)
{
    ...
    wolfSSL_CTX_use_PrivateKey_file(serverTls12Ctx, ourKey, WOLF_SSL_FILETYPE_PEM);
#endif
    ...
    wolfSSL_CTX_use_PrivateKey_file(serverCtx, ourKey, WOLF_SSL_FILETYPE_PEM);
#endif
    ...
    AssertIntEQ(wolfSSL_send_hrr_cookie(serverSsl, NULL, 0), WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(wolfSSL_NoKeyShares(clientTls12Ssl), WOLF_SSL_SUCCESS);
    AssertIntEQ(wolfSSL_NoKeyShares(clientSsl), WOLF_SSL_SUCCESS);
...
void ApiTest(void)
{
    ...
    AssertIntEQ(test_wolfSSL_Init(), WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(test_wolfSSL_CTX_use_certificate_buffer(), WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(test_wolfSSL_SetMinVersion(), WOLF_SSL_SUCCESS);
    AssertIntEQ(test_wolfSSL_CTX_SetMinVersion(), WOLF_SSL_SUCCESS);
    ...
    /*OCSP Stapling. */
    AssertIntEQ(test_wolfSSL_UseOCSPStapling(), WOLF_SSL_SUCCESS);
    AssertIntEQ(test_wolfSSL_UseOCSPStaplingV2(), WOLF_SSL_SUCCESS);
    ...
    AssertIntEQ(test_wolfSSL_Cleanup(), WOLF_SSL_SUCCESS);
